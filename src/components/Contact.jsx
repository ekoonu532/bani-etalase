      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            Kirim pesan untuk pertanyaan atau informasi lebih lanjut tentang produk kami
          </p>
        </motion.div>
        ...
        <div className="flex flex-col lg:flex-row bg-white rounded-lg shadow-xl overflow-hidden">
          <motion.div
            ...
            viewport={{ once: true }}
            className="lg:w-1/3 bg-blue-900 text-white p-8"
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Jl. Industri No. 123, Indo, Southeast Sulawesi</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-blue-100">info@banietalase.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-blue-100">Senin - Sabtu: 08.00 - 17.00</p>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="submit"
                className="bg-blue-800 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg shadow-lg transition duration-300 flex items-center"
              >
